package net.mcreator.potionofdarwinism.recipe.brewing;
...
@EventBusSubscriber
public class DarwinisimBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new DarwinisimBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), PotionOfDarwinismModPotions.DARWINISM_POTION);
		}
